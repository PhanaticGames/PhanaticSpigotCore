...
/**
 * Repersents a title displayed in front of the player
 */
public class Title {
    ...
    public void send(Player player) {
        ...
        try {
            ...
            // NMS Classes
            Class<?> clsPacketPlayOutTitle = ServerClass.MINECRAFT.getClass("PacketPlayOutTitle");
            Class<?> clsPacket = ServerClass.MINECRAFT.getClass("Packet");
            Class<?> clsIChatBaseComponent = ServerClass.MINECRAFT.getClass("IChatBaseComponent");
            Class<?> clsChatSerializer = ServerClass.MINECRAFT.getClass("IChatBaseComponent$ChatSerializer");
            Class<?> clsEnumTitleAction = ServerClass.MINECRAFT.getClass("PacketPlayOutTitle$EnumTitleAction");
